...
public class MainActivity extends AppCompatActivity implements CatAdapter.CatItemListener,
    ...
    btUpadte.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            Cat cat = new Cat();
            String i=sp.getSelectedItem().toString();
            ...
            try{
                ...
                cat.setDescribe(desc);
                cat.setPrice(price);
                adapter.upate(pcurr,cat);
                btAdd.setEnabled(true);
                btUpadte.setEnabled(false);
    ...
    private void initView() {
        ...
        btUpadte = findViewById(R.id.btUpdate);
        btUpadte.setEnabled(false);
